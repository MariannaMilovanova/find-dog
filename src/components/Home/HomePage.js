      ...
      <div className={b(block)}>
        ...
        <div className={b(block, "map-with-form")}>
          <div className={b(block, "map")}>
            ...
            <MapComponent filterMarkers={filterMarkers} radius={get(markers, 'filters.radius', false)} addTempMarker={addTempMarker} markers={markers} selectMarker={selectMarker}/>
          </div>
